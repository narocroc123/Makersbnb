...
task :setup do
  ...
  connection.exec('CREATE TABLE property (id SERIAL PRIMARY KEY, user_id INTEGER REFERENCES users(id), property_name VARCHAR(40), description VARCHAR(300), available_date DATE, price INTEGER, available BOOLEAN);')
